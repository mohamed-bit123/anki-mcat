...
ablation, the outline-coverage map, the AI gold-set vs. baseline comparison, the
prompt-injection test, and the latency benchmark — writing each result to
`verify/artifacts/`. (Needs the
...
| **Prompt injection (§10)** | `python verify/prompt_injection.py`                                   | [`artifacts/prompt-injection.md`](artifacts/prompt-injection.md)                                                   | ✅ hidden-text/key-override/prompt-leak all neutralized; benign item survives |
